...
export default function AbortModal({
  isVisible,
  nextCallback,
  cancelCallback,
}: {
      ...
      <View className="flex-1 justify-center items-center bg-black/60">
        <View className="bg-white px-6 py-6 rounded-xl shadow-lg w-5/6 max-w-md">
          ...
          <Text className="text-gray-700 mb-4 text-center">
            You have not yet reached your destination. Please confirm if you want to abort the trip.
          </Text>
          ...
          <View className="mt-4">
            ...
            >
              <Text className="text-white text-center font-medium text-lg">Abort Trip</Text>
            </Pressable>
